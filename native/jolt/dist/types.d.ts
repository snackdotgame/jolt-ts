...
declare module Jolt {
    ...
    class AssertFailedHandlerJS extends AssertFailedHandler {
        constructor();
        OnAssertFailed(inExpression: number, inMessage: number, inFile: number, inLine: number): void;
    }
    class JoltSettings {
        constructor();
        ...
        get_mAssertFailedHandler(): AssertFailedHandler;
        set_mAssertFailedHandler(mAssertFailedHandler: AssertFailedHandler): void;
        mAssertFailedHandler: AssertFailedHandler;
    }
    class JoltInterface {
