...
<PhysicsDemo demo="collision-layers" hint="Drag to orbit" caption="Same red bodies, two shelves. Blue (different layer) catches them; red (same layer) lets them through." />
